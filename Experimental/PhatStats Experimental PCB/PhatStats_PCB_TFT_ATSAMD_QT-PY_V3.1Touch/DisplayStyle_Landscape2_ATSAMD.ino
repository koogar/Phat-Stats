...
void DisplayStyle_Landscape2_ATSAMD () {
...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
    ...
    */
    ...
    CustomTriggerCPU_BOOST_LSNB2( cpuClockString.toInt     ()); // CPU Frequency
    CustomTriggerGPU_BOOST_LSNB2( gpuCoreClockString.toInt ()); // GPU Frequency
#endif

#ifdef enable_ThrottleIndicator
    CustomTriggerCPU_ThrottleIndicator_LSNB2( cpuString1.toInt() ); //  CPU TJMax/Throttle Incicator BMP
    CustomTriggerGPU_ThrottleIndicator_LSNB2( gpuString1.toInt() ); //  GPU TJMax/Throttle Incicator BMP
#endif
...
void CustomTriggerCPU_ThrottleIndicator_LSNB2(int cpuDegree ) {  // i5-9600k TJMax is 100c
...
void CustomTriggerGPU_ThrottleIndicator_LSNB2(int gpuDegree ) {
...
void CustomTriggerCPU_BOOST_LSNB2(int cpuClockString ) {
...
void CustomTriggerGPU_BOOST_LSNB2(int gpuCoreClockString ) {
