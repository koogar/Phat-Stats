...
#define GPU_TJMAX 83   //  TJ Max for the Nvidia GTX1080 = 83c / RTX3090 95c

/* CPU & GPU Turbo/Boost Frequency Values in Mhz */
// Intel Core i9-13900k = P-Core: 3 GHz E-Core: 2.2 GHz / P-Core Turbo: 5.4 GHz E-Core Turbo: 4.3 GHz/ tjmax 100c
#define CPU_BOOST 3700  //  Enter Stock CPU Frequency eg. Intel Core i5-9600k = 3700MHz 

//RTX3090 1.4GHz and a boost clock of 1.7GHz / tjmax 95c
...
int debounceButton = 50; //  Use a 0.1uf/100nf/(104) ceramic capacitor from button Pin to GND
