  ...
  /*
    ...
    V3.1.2  Kiss & ADV
        ...
        Add support for:
                          ...
                          Seeed Studio XIAO (ESP32C3)  / Adafruit QT PY (ESP32C3) (untested)
...
/* WIO Backlight control FET is PWM capable but a third party library is needed to drive it, use "fixedBacklight" for now */

//#define fixedBacklight // enable a fixed backlight (no PWM) powered from VCC

/*Start Up PWM Brightness if using MCU Pin*/

//Wio Terminal LCD backlight brightness Range = 1 to 10, XIAO Range = 1 to 254
volatile int brightness_count = 10; // Start Up PWM Brightness
...
int debounceButton = 200; //  Use a 0.1uf/100nf/(104) ceramic capacitor from button Pin to GND
