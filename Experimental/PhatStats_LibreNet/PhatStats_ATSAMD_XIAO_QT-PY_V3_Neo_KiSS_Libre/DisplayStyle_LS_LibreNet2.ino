...
void DisplayStyle_LibreNet_Landscape2 () {
...
void CustomTriggerCPU_ThrottleIndicator_LS_LibreNet2(int cpuDegree ) {  // i5-9600k TJMax is 100c
...
void CustomTriggerGPU_ThrottleIndicator_LS_LibreNet2(int gpuDegree ) {
...
void CustomTriggerCPU_BOOST_LS_LibreNet2(int cpuClockString ) {
...
void CustomTriggerGPU_BOOST_LS_LibreNet2(int gpuCoreClockString ) {
