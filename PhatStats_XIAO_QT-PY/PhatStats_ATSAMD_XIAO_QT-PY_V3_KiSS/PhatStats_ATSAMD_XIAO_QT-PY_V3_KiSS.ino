#define CODE_VERS  "3.0.0.KiSS"  // Code version number
...
/*
  ...
  Libraries
  ---------
  Adafruit Neopixel (only used for the QT-PY TX light which is a neopixel)
...
#include <Adafruit_NeoPixel.h>  // (only used for the QT-PY TX light which is a neopixel)
