...
void Display_LS () {
  ...
  if (stringComplete) {
    ...
    tft.println("Temp  /    Load    /  Power"); // CPU
...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
    ...
    tft.setCursor(242, 34); // (Left/Right, UP/Down)
    tft.setTextSize(2);
    ...
    */
    ...
    /* GPU Core Freq, */
    int gpuCoreClockStart = inputString.indexOf("GCCC") + 3;
    ...
    */
    ...
    tft.setTextSize(2);
    //tft.setCursor(205, 180);   // (Left/Right, UP/Down)
    tft.setCursor(242, 180);   // (Left/Right, UP/Down)
    //tft.print("Power    :");
