...
#define cpuNameStartLength 19 //eg: i5-9600k = 10 / i9-13900k = 19
#define gpuNameStartLength 19 //eg: Geforce GTX1080 (non Ti) = 18 
...
#define enable_cpuPowerStats // Libre Hardware Monitor port only
//>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
volatile int brightness_count = 255; // Start Up PWM Brightness
...
//#define Debug  //Show data clearing fields
...
/*
  ...
  V3.1.7.3.ADV
       ...
       Add CPU Power, only works with Hardware Serial Monitor v3 (ported to Libre Hardware Monitor using PawnIO, instead of Winring0)
