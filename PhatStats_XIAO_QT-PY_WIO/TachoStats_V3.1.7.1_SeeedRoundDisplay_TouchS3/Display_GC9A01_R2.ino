...
void Display_GC9A01_Port_R2() {  // Round 240x240 portrait
...
#define Y_Offset  0  // + Portrait
  ...
  if (stringComplete) {
    ...
    tft.setTextSize(1); tft.println("R2");
    ...
    tft.setTextSize(1); tft.println("180");
    //---------------------------------------CPU & GPU Hardware ID---------------------------------------------------------
...
#define GC9A01A_updateBox  GC9A01A_BLACK // Default for normal running
    ...
    CustomTriggerCPU_BOOST_Rot2( cpuClockString.toInt     ()); // CPU Frequency
    CustomTriggerGPU_BOOST_Rot2( gpuCoreClockString.toInt ()); // GPU Frequency
#endif

#ifdef enable_ThrottleIndicator
    CustomTriggerCPU_ThrottleIndicator_Rot2( cpuString1.toInt() ); //  CPU TJMax/Throttle Incicator BMP
    CustomTriggerGPU_ThrottleIndicator_Rot2( gpuString1.toInt() ); //  GPU TJMax/Throttle Incicator BMP
#endif
...
void CustomTriggerCPU_BOOST_Rot2(int cpuClockString ) {
...
void CustomTriggerGPU_BOOST_Rot2(int gpuCoreClockString ) {
...
void CustomTriggerCPU_ThrottleIndicator_Rot2(int cpuDegree ) {  // i5-9600k TJMax is 100c
...
void CustomTriggerGPU_ThrottleIndicator_Rot2(int gpuDegree ) {
...
void CPU_tempLevel_Rot2(int cpuDegree ) {
...
void CPU_loadLevel_Rot2(int cpuUsage ) {
...
void GPU_tempLevel_Rot2(int gpuDegree ) {
...
void GPU_loadLevel_Rot2(int gpuUsage ) {
